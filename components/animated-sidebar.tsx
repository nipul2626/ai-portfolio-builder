...
export function AnimatedSidebar({ onCollapse }: AnimatedSidebarProps) {
    ...
    >
      ...
      <div className="px-3 py-2">
        <motion.div
          ...
          whileTap={{ scale: 0.98 }}
          className={`flex items-center gap-3 px-3 py-3 rounded-lg text-slate-400 hover:text-white transition-all cursor-pointer ${
      ...
      <div className="border-t border-white/10 p-3">
        ...
        >
          <motion.div
            whileHover={{ scale: 1.1 }}
            className="w-10 h-10 bg-gradient-to-br from-cyan-400 to-blue-600 rounded-full flex items-center justify-center text-white font-semibold flex-shrink-0"
          >
            JD
          </motion.div>
          <AnimatePresence mode="wait">
            {!isCollapsed && (
              ...
              >
                ...
                <div className="text-slate-400 text-xs truncate">john@example.com</div>
              </motion.div>
            )}
          </AnimatePresence>
        </motion.div>
